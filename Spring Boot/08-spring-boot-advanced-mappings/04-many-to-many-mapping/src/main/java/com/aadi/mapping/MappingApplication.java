...
import com.aadi.mapping.entity.*;
...
public class MappingApplication {
	...
	private void createCourseAndStudents(AppDAO appDAO) {
		Course tempCourse = new Course("DMA");

		Student tempStudent1 = new Student("Aaditya","Padte","aa@gmail.com");
		Student tempStudent2 = new Student("Vedant","Kale","vv@gmail.com");
	...
	private void createCourseAndReviews(AppDAO appDAO) {
		Course course = new Course("Master AI Engineering");

		course.addReview(new Review("Good course with deep demonstarations"));
		course.addReview(new Review("Best course in the market"));
		course.addReview(new Review("Worst nightmare for me...."));
